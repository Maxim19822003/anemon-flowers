...
const testimonials = [
  ...
  },
  {
    ...
    name: "Дмитрий Иванов",
    role: "Постоянный клиент",
    testimonial: "Постоянно заказываю цветы только в этом магазине. Всегда помогают выбрать идеальный букет под любой случай. Качество цветов и обслуживание на высшем уровне!",
